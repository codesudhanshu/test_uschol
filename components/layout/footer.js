		...
		<div className="relative">
			...
			<div className="bg-[#1E1E1E] py-8 md:py-16 px-6 lg:py-20  lg:px-8 max-w-screen">
				<Row
						...
						<div className=" mx-auto mt-6 lg:mt-0">
							...
							>
								...
								>
									<div style={{ fontFamily: "Poppins" }} className="text-white flex flex-col content-between">
										...
										<Link
											href="/privacypolicy"
										>
											<p className="font-medium mt-3">Privacy Policy</p>
										</Link>
										<Link
											href="/termsandcondition"
										>
											<p className="font-medium mt-3">Terms & Conditions</p>
										</Link>
								...
								<Row gutter={16} className="mt-3">
						     	<Col>
							    <Link href="https://www.instagram.com/upschol/" target="_blank" rel="noopener noreferrer">
												<InstagramOutlined style={{ fontSize: '28px', color: '#fff' }} />
								</Link>
                                </Col>
								<Col>
								<Link href="https://www.linkedin.com/company/upschol/posts/?feedView=all" target="_blank" rel="noopener noreferrer">
								<LinkedinOutlined style={{ fontSize: '28px', color: '#fff' }} />
								</Link>
								</Col>
											<Col>
											<Link href="https://www.facebook.com/profile.php?id=61552821882181" target="_blank" rel="noopener noreferrer">
												<FacebookOutlined style={{ fontSize: '28px', color: '#fff' }} />
											</Link>
											</Col>
											<Col>
											<Link href="https://www.youtube.com/@upskillwithus" target="_blank" rel="noopener noreferrer">
												<YoutubeOutlined style={{ fontSize: '28px', color: '#fff' }} />
											</Link>
											</Col>
										</Row>
										</div>
					...
					<p style={{ color: "white", textAlign: 'center' }} className="text-white">© 2025 UpSchol. All rights reserved.</p>
				</Row>
			</div>
		</div >
